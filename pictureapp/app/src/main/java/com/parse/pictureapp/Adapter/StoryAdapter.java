...
import com.parse.pictureapp.AddStoryActivity;
import com.parse.pictureapp.Model.Story;
import com.parse.pictureapp.Model.User;
import com.parse.pictureapp.R;
import com.parse.pictureapp.StoryActivity;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                    .exists() && System.currentTimeMillis() < snapshot.getValue(Story.class)
                    .getTimeend()){
                        i++;
                    }
                }
